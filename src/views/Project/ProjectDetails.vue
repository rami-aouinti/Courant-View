              ...
              <div class="d-flex align-center">
                <div>
                  ...
                  <p class="text-sm text-body font-weight-light mb-0">
                    Project no.
                    <span class="font-weight-bold">{{ project.id }}</span> from
                    <span class="font-weight-bold">
                      {{ project.finishDate }}</span
                    >
                  </p>
...
export default {
  ...
  methods: {
    activateProject() {
      ProjectService.activateProject(this.$route.params.id).then(
        (response) => {
    ...
    deactivateProject() {
      ProjectService.deactivateProject(this.$route.params.id).then(
        (response) => {
          console.log(response);
    ...
    addTask() {
      ...
      this.task.description = "Description 1";
      this.task.brief = "brief 1";
      this.task.startDate = new Date("2023-06-22");
      this.task.finishDate = new Date("2023-06-22");
      console.log(this.task);
      ProjectService.addTask(this.$route.params.id, this.task).then(
        (response) => {
          console.log(response);
        },
        (error) => {
  ...
  mounted() {
    ProjectService.getProject(this.$route.params.id).then(
      (response) => {
        console.log(response);
